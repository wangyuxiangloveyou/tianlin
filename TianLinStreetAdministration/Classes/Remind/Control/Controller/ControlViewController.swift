...
class ControlViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        firstView?.cellClourseONE = {
            () in
            let vc=ControlViewDetailController()
...
//Mark: KtcSegCtrl代理
extension ControlViewController:KtcSegCtrlDelegate{
...
extension ControlViewController:UIScrollViewDelegate{
