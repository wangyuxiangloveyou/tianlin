...
//
//  ControlViewDetailController.swift
...
class ControlViewDetailController: UIViewController {
...
extension ControlViewDetailController:UITableViewDelegate,UITableViewDataSource
{
